...
assert.doesNotMatch(workerRoute, /recipientEmail|recipientEmails|payloadJson|subject|message/, "SCALE-4D: la réponse interne ne doit exposer aucun destinataire ni contenu métier.");
