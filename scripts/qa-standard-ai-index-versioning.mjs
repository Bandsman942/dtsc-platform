...
for (const field of ["embeddingProviderCode", "embeddingModelCode", "embeddingDimension", "indexVersion", "chunkingVersion", "indexedAt"]) expect(migration.includes(`\"${field}\"`), `Index metadata missing: ${field}`);
