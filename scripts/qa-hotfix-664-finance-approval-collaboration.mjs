...
const shared = read("components/enterprise/professional/finance-professional-workspace-core.tsx");
...
const paymentsUi = read("components/enterprise/professional/enterprise-finance-payments-workspace.tsx");
const invoicesUi = read("components/enterprise/professional/enterprise-finance-invoices-workspace.tsx");
