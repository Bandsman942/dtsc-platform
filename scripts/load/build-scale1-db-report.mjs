...
const report = {
  ...
  evidence: {
    loadExecution: "LOCAL_EXECUTED",
    note: "This artifact is generated by the manually dispatched SCALE-1B workflow. It does not certify SCALE-7 stages above 500 VU.",
  },
};
