...
const appOnlyRedirectRoutes = ["/dashboard", "/chat", "/billing", "/company", "/calendar", "/documents", "/enterprise-admin", "/enterprise-activities", "/collaborators", "/profile", "/settings", "/notifications", "/announcements"];
