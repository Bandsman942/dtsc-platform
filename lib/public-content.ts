...
export const legalPages: Record<string, PublicPageContent> = {
  terms: {
    ...
    intro:
      "Ces conditions encadrent l'accès aux pages publiques, à l'espace client, au chatbot, aux modules support, annonces, bannières promotionnelles et notifications de la plateforme DTSC.",
    narrative:
    ...
    sections: [
      ...
      {
        heading: "Plans SaaS et abonnements organisationnels",
        text:
          "Les entreprises clientes peuvent disposer de plans organisationnels Starter, Business ou Enterprise. Ces plans déterminent les limites d'usage, les modules disponibles et l'accès aux fonctionnalités comme Administration [Entreprise], Activités [Entreprise], calendrier interne, appels collaboratifs, workflows ou modules sectoriels avancés. Un espace actif sans abonnement valide peut conserver un accès minimal lisible, notamment au support, tandis qu'un espace suspendu est restreint jusqu'à régularisation. Le client peut consulter son statut, ses limites et ses enregistrements de facturation dans son espace, mais les modifications de plan, activation, suspension ou archivage restent administrées par DTSC ou selon le contrat applicable.",
        bullets: ["Plans Starter, Business et Enterprise", "Modules contrôlés par plan et abonnement", "Accès minimal possible sans abonnement actif", "Suspension avec restriction explicite", "Modification de plan réservée aux processus autorisés"],
      },
      {
    ...
    sections: [
      {
        ...
        text:
          "Le cookie de session sécurisé permet à un utilisateur connecté d'accéder à son espace privé sans ressaisir ses identifiants à chaque page. Il est HTTP-only, signé côté serveur et nécessaire à l'authentification, au contexte actif d'entreprise et au contrôle des accès par rôle, poste officiel RH, membership actif et appartenance aux objets. Quand les sous-domaines officiels DTSC sont activés, ce cookie peut être configuré côté serveur sur le domaine parent afin de fonctionner entre l'espace compte, l'espace SaaS, la console et le support sans exposer le contenu du cookie au JavaScript client. Sans ce cookie, les modules privés comme le dashboard, le chatbot, l'entreprise, les activités collaborateur, la déclaration de prestations, le support ou l'administration ne peuvent pas fonctionner correctement. La fonctionnalité de prestations n'ajoute aucun cookie de suivi ou traceur publicitaire spécifique.",
        bullets: ["Session authentifiée", "Contexte actif d'entreprise", "Plan et statut d'accès vérifiés côté serveur", "Protection HTTP-only", "Partage contrôlé entre sous-domaines officiels", "Accès aux routes privées", "Contrôle d'accès aux activités et sections sensibles", "Expiration de session pour sécurité"],
      },
      {
        heading: "Préférences locales et PWA",
        text:
          "Certaines préférences peuvent être conservées localement dans le navigateur: thème clair/sombre, choix de reporter l'installation PWA, notifications visibles déjà affichées ou réglages d'interface. La fermeture d'une bannière promotionnelle connectée est surtout mémorisée côté serveur afin d'éviter sa réapparition sur le compte concerné. D'autres préférences privées peuvent être enregistrées sur le compte utilisateur pour retrouver la page de démarrage, la densité d'affichage, la langue, le fuseau horaire, le format de date, les synthèses email, les préférences de réponse IA et les réglages d'appel après reconnexion. La session peut aussi conserver le contexte d'entreprise actif afin d'appliquer les modules sectoriels et l'isolation par organisation. Ces préférences servent aussi à afficher correctement l'heure des messages chatbot, commentaires, notifications, alertes d'appel et messages de groupe. Ces informations améliorent l'expérience sans être utilisées pour du ciblage publicitaire. La PWA peut aussi mettre en cache des fichiers statiques afin de charger l'interface plus vite, mais elle ne cache pas les pages privées ni les réponses API contenant des données utilisateur.",
        bullets: ["Thème et confort visuel", "Préférences privées persistées", "Fermeture de bannières mémorisée côté compte", "Heures des messages selon le fuseau horaire utilisateur", "Invitation PWA mémorisée", "Pas de cache API privée", "Page hors ligne sans données personnelles"],
      },
      {
