  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        text:
          "DTSC applique une séparation entre les clés API serveur et le frontend, utilise des sessions sécurisées, conserve les mots de passe sous forme hachée et protège les routes privées par rôle. Dans le modèle multi-entreprises, les données internes d'une entreprise cliente doivent être isolées par organisation et accessibles uniquement aux membres actifs autorisés. En contexte entreprise, seuls l'abonnement, les annonces et le profil restent communs au compte; les autres modules doivent être propres au contexte actif ou bloqués lorsqu'ils ne sont pas isolés. Les groupes transversaux Mes collaborateurs peuvent proposer une recherche limitée d'utilisateurs actifs afin d'envoyer une invitation, mais les messages restent invisibles sans acceptation. Les secteurs, modules, postes et workflows d'une entreprise servent à adapter l'expérience SaaS et ne donnent pas à DTSC un accès au contenu privé de cette entreprise. L'espace interne DTSC est lui-même une organisation dédiée: seuls les collaborateurs DTSC rattachés à un dossier RH actif peuvent y accéder. DTSC administre la plateforme, les abonnements et le support, mais ne consulte pas les modules internes privés des clients sans rattachement explicite à l'organisation concernée.",
