  ...
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        text:
          "Les modules internes de gestion RH, financière, achats, stocks, actifs, biens matériels, logistique, coordination COO, supervision CEO, projets MPO, technologie CTO et conseil juridique LA sont réservés aux utilisateurs habilités. Les sections métier sensibles exigent le poste officiel correspondant dans le dossier RH, sauf administrateur. Les informations saisies doivent être exactes, nécessaires au travail, proportionnées et traitées avec confidentialité. Les collaborateurs, postes officiels, responsables, fournisseurs, comptes, budgets, transactions, paies, inventaires, équipements, projets, livrables, incidents techniques, dossiers juridiques, contrats, risques de conformité, documents officiels, litiges, tâches, blocages, réunions, groupes de réunion, appels audio/vidéo, rapports, demandes directes entre collaborateurs, workflows, objectifs et journaux de supervision peuvent être reliés entre eux pour renforcer la cohérence opérationnelle. Lorsqu'un objectif, un suivi, une réunion COO, une demande collaborateur, un besoin matériel, un projet, une tâche technique ou une demande juridique vise un collaborateur, il peut apparaître dans son espace Activités DTSC avec commentaires et notifications ciblées. Les actions sensibles peuvent être journalisées afin d'assurer le contrôle interne, l'audit et la traçabilité.",
        bullets: ["Accès réservé par rôle et poste officiel", "Données internes et juridiques confidentielles", "Référentiels collaborateurs, postes, fournisseurs et biens matériels", "Paie, projets, technologie, juridique et activités visibles uniquement selon habilitation", "Formulaires collaborateur synchronisés avec COO et LA", "Exactitude et proportionnalité", "Traçabilité des actions sensibles"],
      },
      {
  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        text:
          "La plateforme peut s'appuyer sur des services techniques comme l'hébergement Vercel, la base Neon PostgreSQL, l'API OpenAI côté serveur, LiveKit pour les rooms audio/vidéo lorsque cette option est configurée et le fournisseur email configuré. Ces prestataires interviennent pour l'hébergement, la persistance des données, l'inférence IA, les appels collaboratifs, les notifications commerciales ou la sécurité applicative. DTSC doit veiller à sélectionner des prestataires présentant des garanties appropriées et à documenter les traitements lorsque le cadre juridique l'exige.",
        bullets: ["Hébergement cloud", "Base de données PostgreSQL", "Traitement IA côté serveur", "Rooms audio/vidéo LiveKit si configurées", "Notification email des prospects qualifiés", "Documentation des garanties prestataires"],
      },
    ],
  },
  cookies: {
