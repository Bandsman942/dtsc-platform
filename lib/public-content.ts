...
export const legalPages: Record<string, PublicPageContent> = {
  terms: {
    ...
    sections: [
      ...
      {
        heading: "Modules internes HR & CFO / SCO / COO / CEO / MPO / CTO",
        text:
          "Les modules internes de gestion RH, financière, achats, stocks, actifs, biens matériels, logistique, coordination COO, supervision CEO, projets MPO et technologie CTO sont réservés aux utilisateurs habilités. Les informations saisies doivent être exactes, nécessaires au travail, proportionnées et traitées avec confidentialité. Les collaborateurs, postes officiels, responsables, fournisseurs, comptes, budgets, transactions, paies, inventaires, équipements, projets, livrables, incidents techniques, tâches, blocages, réunions, rapports, workflows, objectifs et journaux de supervision peuvent être reliés entre eux pour renforcer la cohérence opérationnelle. Lorsqu'un objectif, un suivi, un besoin matériel, un projet ou une tâche technique vise un collaborateur, il peut apparaître dans son espace Activités DTSC avec commentaires et notifications ciblées. Les actions sensibles peuvent être journalisées afin d'assurer le contrôle interne, l'audit et la traçabilité.",
        bullets: ["Accès réservé par rôle et poste officiel", "Données internes confidentielles", "Référentiels collaborateurs, postes, fournisseurs et biens matériels", "Paie, projets, technologie et activités visibles uniquement selon habilitation", "Exactitude et proportionnalité", "Traçabilité des actions sensibles"],
      },
      {
