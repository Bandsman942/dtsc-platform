    ...
    sections: [
      {
        ...
        text:
          "La plateforme peut traiter les informations de compte, les coordonnées professionnelles, le rôle utilisateur, les paramètres de sécurité, les préférences privées du compte, les conversations chatbot, les tickets support, les annonces, les commentaires, les notifications, les journaux d'usage IA, les données techniques nécessaires au fonctionnement, les statistiques de visites des pages publiques et, pour les utilisateurs autorisés, des données internes de gestion HR & CFO, SCO ou COO comme dossiers RH, responsables hiérarchiques, KPIs, départements, comptes, budgets, transactions, paies, factures, fournisseurs, achats, biens matériels, stocks, actifs, opérations logistiques, tâches internes, réunions, blocages, workflows, rapports et pièces justificatives stockées côté serveur.",
        bullets: ["Identité et coordonnées professionnelles", "Préférences privées de compte et d'interface", "Messages, tickets et conversations", "Données internes HR & CFO / SCO / COO selon habilitation", "Rôles, statuts et limites d'usage", "Journaux techniques et statistiques de visite"],
      },
      {
