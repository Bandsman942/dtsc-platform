  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        text:
          "La plateforme peut s'appuyer sur des services techniques comme l'hébergement Vercel, la base Neon PostgreSQL, l'API OpenAI côté serveur et le fournisseur email configuré. Ces prestataires interviennent pour l'hébergement, la persistance des données, l'inférence IA, les notifications commerciales ou la sécurité applicative. DTSC doit veiller à sélectionner des prestataires présentant des garanties appropriées et à documenter les traitements lorsque le cadre juridique l'exige.",
        bullets: ["Hébergement cloud", "Base de données PostgreSQL", "Traitement IA côté serveur", "Notification email des prospects qualifiés", "Documentation des garanties prestataires"],
      },
    ],
  },
  cookies: {
