...
const fr: Record<Iteration05GuideCode, ContextualUserGuide> = {
  ...
  AI_TOOLS_AND_CONFIRMATIONS: {
    ...
    updatedAt: "2026-08-04",
    capabilities: ["Registre canonique des outils", "Permissions serveur", "Aperçu avant action", "Confirmation explicite", "Idempotence", "Audit et lien profond"],
    steps: [
      ...
      { title: "Confirmation", description: "Avant une action sensible, vérifiez l’objet, les effets, les destinataires, les données modifiées et les risques." },
...
const en: Record<Iteration05GuideCode, ContextualUserGuide> = {
  ...
  AI_TOOLS_AND_CONFIRMATIONS: {
    ...
    updatedAt: "2026-08-04",
    capabilities: ["Canonical tool registry", "Server permissions", "Preview before action", "Explicit confirmation", "Idempotency", "Audit and deep link"],
    steps: [
      ...
      { title: "Confirm", description: "Before a sensitive action, review the object, effects, recipients, modified data and risks." },
