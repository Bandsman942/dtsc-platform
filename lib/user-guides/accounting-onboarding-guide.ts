...
const FR: ContextualUserGuide = {
  ...
  summary: "Démarrer avec le plan SYSCOHADA par défaut de DTSC, suivre l’assistant de mise en service piloté par le serveur, corriger les blocages puis activer la comptabilité.",
  ...
  limitations: [
    ...
    "La stabilisation technique de l’onboarding et du posting ne vaut pas certification réglementaire du plan ou des déclarations d’un pays.",
  ],
};
...
const EN: ContextualUserGuide = {
  ...
  summary: "Start with DTSC’s default SYSCOHADA chart, follow the server-driven setup assistant, resolve blockers, then activate accounting.",
  ...
  limitations: [
    ...
    "Technical stabilization of onboarding and posting is not a regulatory certification of a country chart or filing regime.",
  ],
};
