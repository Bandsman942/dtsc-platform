...
export const CONSOLE_CAPABILITIES = {
  ...
  FINANCE_INVOICES_READ: "CONSOLE_FINANCE_INVOICES_READ",
  FINANCE_INVOICES_MANAGE: "CONSOLE_FINANCE_INVOICES_MANAGE",
...
export const CONSOLE_CAPABILITY_SECTIONS: Record<ConsoleCapability, ConsoleSectionId> = {
  ...
  CONSOLE_FINANCE_INVOICES_READ: "hr-cfo",
  CONSOLE_FINANCE_INVOICES_MANAGE: "hr-cfo",
...
export const CONSOLE_CAPABILITY_LABELS: Record<ConsoleCapability, { fr: string; en: string; category: string }> = {
  ...
  CONSOLE_FINANCE_INVOICES_READ: { fr: "Consulter les factures des transactions HR & CFO", en: "Read HR & CFO transaction invoices", category: "Administration DTSC · HR & CFO" },
  CONSOLE_FINANCE_INVOICES_MANAGE: { fr: "Gérer les factures des transactions HR & CFO", en: "Manage HR & CFO transaction invoices", category: "Administration DTSC · HR & CFO" },
