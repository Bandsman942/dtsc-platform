...
const requestTemplate: EnterpriseWorkflowTemplate = {
  ...
  version: {
    steps: [
      ...
      { code: "CREATE_TASK", name: "Créer la tâche", stepType: "CREATE_TASK", position: 2, configuration: { titleTemplate: "Traiter {{entity.reference}} — {{entity.title}}", descriptionTemplate: "Tâche générée par {{workflow.name}}.", taskType: "TASK", priority: "NORMAL", assignment: { strategy: "ENTITY_ASSIGNEE" } } },
