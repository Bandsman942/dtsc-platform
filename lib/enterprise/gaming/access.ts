...
async function getEnterpriseGamingModuleAccess({ session, organizationId, moduleCode, action }: { session: SessionPayload; organizationId: string; moduleCode: GamingOperationalModuleCode; action: GamingAccessAction }) {
...
export function getEnterpriseGamingDashboardAccess({ session, organizationId, action }: { session: SessionPayload; organizationId: string; action: GamingAccessAction }) {
  return getEnterpriseGamingModuleAccess({ session, organizationId, moduleCode: "GAMING_DASHBOARD", action });
}
...
export function getEnterpriseGamingTournamentAccess({ session, organizationId, action }: { session: SessionPayload; organizationId: string; action: GamingAccessAction }) {
  return getEnterpriseGamingModuleAccess({ session, organizationId, moduleCode: "GAMING_TOURNAMENTS", action });
}
export function getEnterpriseGamingReportAccess({ session, organizationId, action }: { session: SessionPayload; organizationId: string; action: GamingAccessAction }) {
  return getEnterpriseGamingModuleAccess({ session, organizationId, moduleCode: "GAMING_REPORTS", action });
}
