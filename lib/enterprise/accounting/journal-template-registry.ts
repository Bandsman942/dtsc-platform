...
export const RECOMMENDED_ACCOUNTING_JOURNALS = Object.freeze([
  ...
  { code: "MM", nameFr: "Journal Mobile Money", nameEn: "Mobile Money journal", journalType: "MOBILE_MONEY", sequencePrefix: "MM", requiresApproval: false, postingEvents: ["RETAIL_MOBILE_MONEY_POSTED", "RETAIL_MOBILE_MONEY_REVERSED", "RETAIL_MOBILE_MONEY_FX_POSTED", "RETAIL_MOBILE_MONEY_FX_REVERSED"] },
  ...
  { code: "IM", nameFr: "Journal des immobilisations", nameEn: "Assets journal", journalType: "ASSETS", sequencePrefix: "IM", requiresApproval: true, postingEvents: ["ASSET_CAPITALIZED", "ASSET_DEPRECIATION_POSTED", "ASSET_DISPOSAL_POSTED"] },
  { code: "OD", nameFr: "Opérations diverses", nameEn: "General adjustments", journalType: "ADJUSTMENT", sequencePrefix: "OD", requiresApproval: true, postingEvents: ["PAYMENT_ALLOCATION_CONFIRMED", "HEALTH_WRITE_OFF_APPROVED", "FX_CLOSING_REVALUATION_POSTED", "YEAR_END_CLOSED"] },
