...
export const POSTING_EVENTS = [
  ...
  "ACCOUNTING_RECURRING_POSTED",
  "ACCOUNTING_ACCRUAL_POSTED",
  "ACCOUNTING_DEFERRAL_POSTED",
  "ACCOUNTING_ALLOCATION_POSTED",
  "ACCOUNTING_FX_REVALUATION_POSTED",
  "ACCOUNTING_YEAR_END_POSTED",
  "RETAIL_POS_SALE_POSTED",
  "RETAIL_POS_SALE_REVERSED",
  "RETAIL_POS_RETURN_POSTED",
