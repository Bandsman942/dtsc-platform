...
const BUSINESS_LABELS = {
  ...
  "finance.report.incomeStatement": { fr: "Compte de résultat", en: "Income statement" },
  "finance.report.balanceSheet": { fr: "Bilan", en: "Balance sheet" },
  "finance.report.cashFlow": { fr: "Tableau des flux de trésorerie", en: "Cash flow statement" },
  "finance.report.treasury": { fr: "Situation de trésorerie", en: "Treasury statement" },
  "finance.report.receivablesAging": { fr: "Ancienneté des créances", en: "Aged receivables" },
  "finance.report.payablesAging": { fr: "Ancienneté des dettes", en: "Aged payables" },
  "finance.report.budgetActual": { fr: "Budget comparé au réalisé", en: "Budget vs actual" },
  "finance.report.taxSummary": { fr: "Synthèse fiscale", en: "Tax summary" },
  "finance.report.assetRegister": { fr: "Registre des actifs", en: "Asset register" },
  "finance.report.inventoryValuation": { fr: "Valorisation du stock", en: "Inventory valuation" },
  "finance.snapshot": { fr: "Situation enregistrée", en: "Recorded snapshot" },
  "finance.snapshot.immutable": { fr: "Version publiée non modifiable", en: "Published immutable snapshot" },
  "finance.account.asset": { fr: "Actif", en: "Asset" },
  "finance.account.liability": { fr: "Passif", en: "Liability" },
  "finance.account.equity": { fr: "Capitaux propres", en: "Equity" },
  "finance.account.revenue": { fr: "Produit", en: "Revenue" },
  "finance.account.expense": { fr: "Charge", en: "Expense" },
  "finance.journal.general": { fr: "Journal général", en: "General journal" },
  "finance.journal.sales": { fr: "Journal des ventes", en: "Sales journal" },
  "finance.journal.purchases": { fr: "Journal des achats", en: "Purchases journal" },
  "finance.transaction.inflow": { fr: "Entrée", en: "Inflow" },
  "finance.transaction.outflow": { fr: "Sortie", en: "Outflow" },
