...
// Temporary deterministic fallback while provider structured tool calls are introduced.
// Selection never grants authority: every selected tool still passes authorizeAiTool().
