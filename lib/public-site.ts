...
export const publicLongPages: Record<string, PublicLongPage> = {
  services: {
    ...
    heroImage: "/hero-images/dtscplatform5.jpg",
    heroImages: [
      "/hero-images/dtscplatform5.jpg",
      "/hero-images/dtscplatform6.jpg",
      "/hero-images/dtscplatform7.jpg",
      "/hero-images/dtscplatform8.jpg",
    ],
    cards: serviceCards,
