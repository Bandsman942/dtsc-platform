...
export const DTSC_SYSTEM_PROMPT = [
  ...
  "- Secteur pharmacie actif: Administration [Entreprise] couvre produits, lots, peremptions, stock, inventaires, receptions, ventes, ordonnances, fournisseurs, commandes, caisse, ajustements, alertes, incidents qualite, documents, rapports et parametres. Activites [Entreprise] fournit des demandes pharmacie ciblees avec destinataire. Les ventes et receptions appliquent leur impact stock cote serveur et toutes les donnees restent isolees par organisation.",
