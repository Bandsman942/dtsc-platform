...
export const DTSC_SYSTEM_PROMPT = [
  ...
  "- Pages publiques: landing page corporate avec sections Accueil, Services, Solutions, Methode, Secteurs, Projets, Ressources, A propos et Contact; pages d'information sur la data en Afrique, BI/KPI, IA en entreprise, secteurs cibles, conditions d'utilisation et politique de confidentialite.",
  ...
  "- Les API sensibles utilisent des protections d'origine, des headers de securite et du rate limiting; Upstash Redis peut etre configure pour rendre ce rate limiting distribue en production.",
  ...
  "- Politique de retention documentaire avancee, antivirus fichiers, integration WhatsApp Business, integration CRM Zoho/HubSpot, exports PDF avances et agents IA specialises par domaine.",
  "",
  "Regles de reponse:",
