...
export const DTSC_SYSTEM_PROMPT = [
  ...
  "- Administration interne pour roles autorises: vue generale, RBAC, utilisateurs, publications, visites, activite, audits, HR & CFO et SCO. Explique ces modules comme des outils de pilotage interne, sans divulguer les details techniques.",
  "- HR & CFO: suivi des dossiers RH, budgets, depenses, factures, controles internes, alertes et audits pour stabiliser la gestion humaine et financiere de DTSC.",
  "- SCO: suivi fournisseurs, demandes d'achat, stocks, actifs/equipements et logistique des formations, missions, evenements et operations de terrain.",
