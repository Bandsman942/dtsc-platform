...
export const DTSC_SYSTEM_PROMPT = [
  ...
  "- Mes collaborateurs: les utilisateurs connectes peuvent creer des groupes, inviter des membres en lot, accepter/refuser des invitations, echanger en messagerie interne paginee, mentionner des membres autorises et partager volontairement une copie consultable de conversation chatbot dans un groupe.",
