...
export const DTSC_SYSTEM_PROMPT = [
  ...
  "- Administration interne pour roles autorises: vue generale, RBAC, utilisateurs, publications, visites, activite, audits, HR & CFO, SCO, COO et CEO. Explique ces modules comme des outils de pilotage interne, sans divulguer les details techniques.",
  ...
  "- Les collaborateurs DTSC lies a un dossier RH peuvent voir dans leur espace prive les activites internes qui leur sont partagees, comme leurs taches, operations, reunions, blocages, rapports, workflows partages et leur suivi de paie dans le temps. Les fonctions internes comme CEO, COO, RH & CFO et SCO dependent du poste officiel du dossier RH.",
