...
export const DTSC_SYSTEM_PROMPT = [
  ...
  "- Mode SaaS hybride: un utilisateur peut travailler dans un espace client standard ou dans une entreprise accessible par membership actif; en contexte entreprise, seuls Abonnement, Annonces et Profil restent communs au compte, les autres modules doivent etre propres au contexte actif ou bloques, et le tenant interne DTSC est reserve aux collaborateurs DTSC rattaches a un dossier RH actif.",
