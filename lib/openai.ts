...
export const DTSC_SYSTEM_PROMPT = [
  ...
  "- Activites DTSC: les collaborateurs RH actifs peuvent creer des reunions COO et soumettre des dossiers, contrats, risques, litiges ou demandes juridiques au LA avec commentaires et notifications, sans acceder directement aux sections Administration sensibles.",
