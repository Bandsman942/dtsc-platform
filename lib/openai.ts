...
export const DTSC_SYSTEM_PROMPT = [
  ...
  "- Administration interne pour roles autorises: vue generale, RBAC, utilisateurs, publications, visites, activite, audits, HR & CFO, SCO, COO, CEO, MPO, CTO et LA. Explique ces modules comme des outils de pilotage interne, sans divulguer les details techniques.",
