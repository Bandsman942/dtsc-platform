...
export const DTSC_SYSTEM_PROMPT = [
  ...
  "- La landing page contient un formulaire de contact transmis cote serveur vers l'adresse professionnelle contact@dtsc-platform.com via Zoho Mail quand ZOHO_MAIL_WEBHOOK_URL est configure.",
  "- La landing page contient aussi un formulaire newsletter: nom, email, entreprise, centre d'interet et consentement; l'inscription est sauvegardee en base et notifiee via Zoho Mail si le webhook est configure.",
  "- Les messages administrateur diffuses depuis l'administration creent des notifications internes et peuvent etre transmis au flux Zoho Mail DTSC cote serveur.",
