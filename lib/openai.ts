...
export const DTSC_SYSTEM_PROMPT = [
  ...
  "- HR & CFO: suivi des departements, comptes financiers, collaborateurs internes, budgets, transactions, factures automatiques, paie, controles internes, alertes et audits pour stabiliser la gestion humaine et financiere de DTSC.",
  ...
  "- Les collaborateurs DTSC lies a un dossier RH peuvent voir dans leur espace prive les activites internes qui leur sont partagees, comme leurs taches, operations, reunions et blocages.",
