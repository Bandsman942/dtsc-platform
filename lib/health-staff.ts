...
export const HEALTH_STAFF_PERMISSIONS = ["health.staff.view","health.staff.create","health.staff.update","health.staff.archive","health.staff.suspend","health.staff.manage_availability","health.staff.manage_permissions","health.staff.view_permissions","health.staff.view_activity","health.staff.manage_specialties","health.patients.view","health.appointments.view","health.appointments.update","health.consultations.view","health.consultations.view_sensitive","health.medical_records.view","health.medical_records.view_sensitive","health.medical_records.confidential_notes","health.laboratory.view","health.laboratory.view_sensitive","health.laboratory.create_request","health.laboratory.update_request","health.laboratory.cancel_request","health.laboratory.collect_sample","health.laboratory.enter_result","health.laboratory.validate_result","health.laboratory.correct_validated_result","health.laboratory.transmit_result","health.laboratory.manage_catalog","health.laboratory.view_result","health.pharmacy.view","health.pharmacy.view_sensitive","health.pharmacy.create_product","health.pharmacy.update_product","health.pharmacy.archive_product","health.pharmacy.manage_batches","health.pharmacy.stock_entry","health.pharmacy.stock_exit","health.pharmacy.dispense","health.pharmacy.adjust_stock","health.pharmacy.manage_inventory","health.pharmacy.authorize_sensitive_exit","health.pharmacy.view_movements","health.billing.view","health.billing.view_sensitive","health.billing.create_invoice","health.billing.update_invoice","health.billing.issue_invoice","health.billing.cancel_invoice","health.billing.record_payment","health.billing.cancel_payment","health.billing.apply_discount","health.billing.apply_large_discount","health.billing.manage_catalog","health.billing.export_invoice","health.billing.view_reports","health.quality.view","health.quality.view_sensitive","health.quality.create_incident","health.quality.update_incident","health.quality.qualify_incident","health.quality.assign_incident","health.quality.investigate_incident","health.quality.close_incident","health.quality.reopen_incident","health.quality.archive_incident","health.quality.manage_corrective_actions","health.quality.validate_corrective_actions","health.quality.view_confidential_incidents","health.quality.view_reports","health.quality.export","health.documents.view","health.documents.view_sensitive","health.documents.view_restricted","health.documents.create","health.documents.update_metadata","health.documents.upload_file","health.documents.download","health.documents.validate","health.documents.reject","health.documents.archive","health.documents.restore","health.documents.manage_versions","health.documents.view_access_logs","health.internal_pharmacy.view","health.medical_billing.view","health.reports.view"] as const;
