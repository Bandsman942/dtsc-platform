...
function GuideMetric({ label, value, icon }: { label: string; value: string; icon?: ReactNode }) {
  return (
...
function formatGuideDate(value: string, locale: string) {
  return new Intl.DateTimeFormat(locale === "en" ? "en-US" : "fr-FR", { dateStyle: "long" }).format(new Date(`${value}T00:00:00Z`));
}
