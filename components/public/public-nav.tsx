...
export function PublicNav() {
  ...
  return (
    <div className="lg:flex lg:items-center lg:gap-2">
      ...
      <nav className={cn("mt-3 grid gap-2 rounded-2xl border border-dtsc-border bg-dtsc-surface p-2 shadow-[0_12px_32px_rgba(0,43,91,0.08)] lg:mt-0 lg:flex lg:border-0 lg:bg-transparent lg:p-0 lg:shadow-none", !open && "hidden lg:flex")}>
