...
type ProjectOverview = ProjectListItem & {
  ...
  issues: Array<{ id: string; reference: string; title: string; description: string; issueType: string | null; priority: string; status: string; dueDate: string | null; resolution: string | null }>;
};
