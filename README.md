...
- Isolation renforcée en contexte entreprise: Abonnement, Annonces et Profil restent communs au compte utilisateur, tandis que Dashboard, Chatbot, Entreprise, Documents, Paramètres, Notifications, Support et Mes collaborateurs restent visibles avec des données filtrées par le contexte actif et `organizationId`.
...
- Calendrier interne privé sans API externe: disponibilités collaborateurs, événements, participants, conflits de planning, vues mobiles premium et synchronisation automatique des tâches/réunions COO datées.
