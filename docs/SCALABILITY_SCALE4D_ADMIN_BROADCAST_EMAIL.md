...
`scripts/qa-scale4d-admin-broadcast-email.mjs` verrouille le contrat : transaction, absence d'appel Zoho dans la requête interactive, cron, claim multi-instance, concurrence bornée, retries/DLQ, observabilité et isolation des workers.
