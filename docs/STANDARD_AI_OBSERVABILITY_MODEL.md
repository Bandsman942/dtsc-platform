...
AI02 étend ce même journal aux tentatives OpenRouter. Aucun second journal provider n'est créé et OpenRouter ne possède aucun fallback caché : `allow_fallbacks:false` garantit que chaque changement de provider/modèle reste une décision DTSC observable.
