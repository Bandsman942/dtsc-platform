...
Ce guide explique l’utilisation opérationnelle de **Calendrier interne** dans DTSC Platform. Il décrit uniquement les actions disponibles dans l’application, leurs règles métier et les contrôles appliqués.
