      ...
      <ModuleWorkspace>
        ...
        <ModuleContent>
          ...
          <ModuleSection title={locale === "fr" ? "État de la consolidation" : "Consolidation status"} description={`${from.toLocaleDateString(locale === "fr" ? "fr-FR" : "en-US")} → ${to.toLocaleDateString(locale === "fr" ? "fr-FR" : "en-US")}`}>
            <div data-consolidation-state={consolidated.complete ? "COMPLETE" : "INCOMPLETE"} className={`rounded-2xl border p-4 ${consolidated.complete ? "border-emerald-500/30 bg-emerald-500/10" : "border-amber-500/30 bg-amber-500/10"}`}>
