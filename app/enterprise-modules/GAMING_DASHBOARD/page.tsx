...
export default async function GamingDashboardPage() {
  ...
  return <AppShell user={user}><EnterpriseGamingDashboardWorkspace organizationId={organizationId} organizationName={organization.name} definition={capabilities.definition} /></AppShell>;
}
