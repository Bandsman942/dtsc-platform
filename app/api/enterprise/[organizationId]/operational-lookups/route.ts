...
export async function GET(req: Request, { params }: Params) {
  ...
  const [members, employees, departments, parties, sites, warehouses, locations, inventoryItems, projects, payrollPeriods, assetCategories, suppliers, contracts] = await Promise.all([
