...
export async function POST(req: Request, { params }: Params) {
  ...
  if (data.moduleCode === "PATIENTS" || data.moduleCode === "APPOINTMENTS" || data.moduleCode === "CONSULTATIONS" || data.moduleCode === "MEDICAL_RECORDS" || data.moduleCode === "CARE_TEAM" || data.moduleCode === "LABORATORY" || data.moduleCode === "INTERNAL_PHARMACY") {
