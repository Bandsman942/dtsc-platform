...
export async function POST(req:Request,{params}:Params){
 ...
 const parsed=healthLabRequestCreateSchema.safeParse(payload);if(!parsed.success)return NextResponse.json({error:"ENTERPRISE_INPUT_INVALID",message:"Vérifiez le patient, le demandeur et les examens sélectionnés."},{status:400});
