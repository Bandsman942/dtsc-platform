...
export async function PATCH(req: Request, { params }: Params) {
  ...
  if (existingRecord.moduleCode === "PATIENTS" || existingRecord.moduleCode === "APPOINTMENTS" || existingRecord.moduleCode === "CONSULTATIONS" || existingRecord.moduleCode === "MEDICAL_RECORDS" || existingRecord.moduleCode === "CARE_TEAM" || existingRecord.moduleCode === "LABORATORY") {
